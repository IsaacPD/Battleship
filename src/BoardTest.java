/**
 * The battlefield for the click enabled game
 * Difference between BoardComponent is that the ships are placed on the board
...
public class BoardTest extends JComponent
{
    final int BOARD = 50;
    final int SHIPSIZE = 49;
    private Rectangle d = new Rectangle(1140, BOARD, 2*SHIPSIZE, SHIPSIZE);
    private Rectangle ca = new Rectangle(1140, BOARD + 360, 5*SHIPSIZE, SHIPSIZE);
    private Rectangle ba = new Rectangle(1140, BOARD + 270, 4*SHIPSIZE, SHIPSIZE);
    private Rectangle s = new Rectangle(1140, BOARD + 180, 3*SHIPSIZE, SHIPSIZE);
    private Rectangle cr = new Rectangle(1140, BOARD + 90, 3*SHIPSIZE, SHIPSIZE);
